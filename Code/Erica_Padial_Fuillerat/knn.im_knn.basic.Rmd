...
Observamos que AUC para h1n1 es ligeramente inferior al AUC para seas.

Probamos kNN usando la distancia de Minkowski con la funcion kknn de kknn:
```{r}
library(kknn)
#Para la vacuna h1n1:
Fit_2_h1n1 = kknn (tra_lab_sam$h1n1_vaccine~., tra_feat_sam , tst_feat_sam , distance = 2)

Pred_2 = predict(Fit_2_h1n1, newdata = tst_feat_sam)
...
#Para la vacuna seas:
Fit_2_seas = kknn (tra_lab_sam$seasonal_vaccine~., tra_feat_sam , tst_feat_sam , distance = 2)
...
Nuevamente vemos que AUC de h1n1 es inferior al de seas, aunque para esta distancia, ambos son inferiores que para la distancia euclídea.

Probamos kNN usando la distancia de Manhattan para el modelo, con la funcion kknn de kknn:
```{r}
#Para la vacuna h1n1:
Fit_3_h1n1 = kknn (tra_lab_sam$h1n1_vaccine~., tra_feat_sam , tst_feat_sam , distance = 1)
...
#Para la vacuna seas:
Fit_3_seas = kknn (tra_lab_sam$seasonal_vaccine~., tra_feat_sam , tst_feat_sam , distance = 1)
...
Por último, la distancia de manhattan presenta mejores resultados que Minkowski, aunque sigue sin superar a la euclídea. Y AUC para seas es mayor que para h1n1.

Por tanto, el mejor resultado nos lo da el modelo producido por el paquete caret, usando la distancia euclídea.
...
```{r}
#Para la vacuna h1n1:
Fit_2_h1n1 = kknn (tra_lab$h1n1_vaccine~., tra_feat , test_feat , distance = 2)
...
#Para la vacuna seas:
Fit_2_seas = kknn (tra_lab$seasonal_vaccine~., tra_feat , test_feat , distance = 2)
...
```{r}
#Para la vacuna h1n1:
Fit_3_h1n1 = kknn (tra_lab$h1n1_vaccine~., tra_feat , test_feat , distance = 1)
...
#Para la vacuna seas:
Fit_3_seas = kknn (tra_lab$seasonal_vaccine~., tra_feat , test_feat , distance = 1)
...
write_csv(submission_knn.im_eu, "F:/Master Ciencia de Datos/Mineria de datos. Preprocesamiento y clasificación/Trabajo/submissions/submission_knn.im_eu.csv")
...
write_csv(submission_knn.im_mk, "F:/Master Ciencia de Datos/Mineria de datos. Preprocesamiento y clasificación/Trabajo/submissions/submission_knn.im_mk.csv")
...
write_csv(submission_knn.im_mh, "F:/Master Ciencia de Datos/Mineria de datos. Preprocesamiento y clasificación/Trabajo/submissions/submission_knn.im_mh.csv")
```
